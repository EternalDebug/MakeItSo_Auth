...
import com.example.makeitso.screens.about_user.AboutUserScreen
...
fun NavGraphBuilder.makeItSoGraph(appState: MakeItSoAppState) {
  ...
  composable(ABOUT_USER_SCREEN) { AboutUserScreen(openAndPopUp = { route, popUp -> appState.navigateAndPopUp(route, popUp) }) }
